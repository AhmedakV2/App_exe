  ...
  return (
    <aside className="drawer">
      <header className="drawer-head">
        ...
        <span className="drawer-push" />
        <IconButton name="close" title="Kapat" onClick={onClose} small />
      </header>
      ...
      <div className="drawer-body">
        ...
        <div className="drawer-msg">{context.message}</div>
            ...
            <div className="rows">
              {context.assertions.map((entry, index) => (
                <div key={index} className="row">
                  ...
                  <Pill tone={entry.passed ? 'ok' : 'bad'}>{entry.passed ? 'geçti' : 'kaldı'}</Pill>
                </div>
              ))}
            </div>
          ) : (
